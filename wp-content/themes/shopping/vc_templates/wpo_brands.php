...
?>
	<section class="wpo-brands <?php echo (($el_class!='')?' '.$el_class:''); ?>">
		<div class="box-content">
			<div class=" no-margin carousel slide" id="brands-<?php echo $_id; ?>" data-ride="carousel">
				<?php if($_total>$columns_count){ ?>
	                <div class="carousel-controls">
	                    <a class="prev" href="#brands-<?php echo $_id; ?>" data-slide="prev">
                            <i class="fa fa-angle-left"></i>
	                    </a>
	                    <a class="next" href="#brands-<?php echo $_id; ?>" data-slide="next">
